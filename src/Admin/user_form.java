    ...
    private void EditMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_EditMouseClicked
        ...
        if(rowIndex < 0){
            ...
            try{
                ...
                ResultSet rs = conf.getData("Select * From accounts Where a_id = '"+tbl.getValueAt(rowIndex, 0)+"'");
                if(rs.next()){
                    cf.uid.setEnabled(false);
                    cf.uid.setText(""+rs.getInt("a_id"));
                    cf.fname.setText(""+rs.getString("fname"));
                    cf.lname.setText(""+rs.getString("lname"));
                    cf.gender.setSelectedItem(""+rs.getString("gender"));
                    cf.usertype.setSelectedItem(""+rs.getString("user_type"));
